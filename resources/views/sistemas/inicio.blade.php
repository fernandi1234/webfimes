<x-app-layout>
    ...
    <div class="chat-notification">
        <div class="chat-notification-logo-wrapper">
            <img class="chat-notification-logo" src="https://pbs.twimg.com/profile_images/2137261758/episunap_400x400.png" alt="ChitChat Logo">
        </div>
        <div class="chat-notification-content">
            <h4 class="chat-notification-title">ingenieria</h4>
            <p class="chat-notification-message">sistemas</p>
        </div>
    </div>
